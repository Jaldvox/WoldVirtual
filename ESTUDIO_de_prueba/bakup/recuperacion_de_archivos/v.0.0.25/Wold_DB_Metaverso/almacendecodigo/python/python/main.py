...
from BlockchainSimple import BlockchainSimple # O el nombre correcto del archivo si es diferente
...
class ModuleVerifier:
    ...
    def __init__(self) -> None:
        ...
        self.modules: Dict[str, str] = {
            "BlockchainSimple": "import BlockchainSimple""
    ...
    def verify_modules(self) -> None:
        ...
        # Crear una instancia de BlockchainSimple
        blockchain_instance = BlockchainSimple()
    
        # Llamar a la función de validación del bloque del módulo
        if blockchain_instance.validate_module_block():
            print("El bloque del módulo 1bk_inistn ha sido validado exitosamente desde main.")
        else:
            print("Falló la validación del bloque del módulo 1bk_inistn desde main.")
